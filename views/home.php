...
<body class="bg-yellow-gradient text-black d-flex align-items-center justify-content-center px-3 py-5 pb-md-55">
	...
	<div>
		...
		<main class="row row-8 row-md-10 mt-45 mt-md-55 justify-content-center text-center">
			<div class="col-auto">
				<a href="kbli-2015" class="text-reset card mb-3 mb-md-35" title="Klasifikasi Baku Lapangan Usaha Indonesia 2015" data-toggle="tooltip" data-placement="bottom" data-trigger="hover">
					<div class="card-body">
			...
			<div class="col-auto">
				<a href="kbji-2014" class="text-reset card mb-3 mb-md-35" title="Klasifikasi Baku Jabatan Indonesia 2014" data-toggle="tooltip" data-placement="bottom" data-trigger="hover">
					<div class="card-body">
			...
			<div class="col-auto">
				<a href="kbki-barang" class="text-reset card mb-3 mb-md-35" title="Klasifikasi Baku Komoditi Indonesia Indonesia - Barang" data-toggle="tooltip" data-placement="bottom" data-trigger="hover">
					<div class="card-body">
			...
			<div class="col-auto">
				<a href="kbki-jasa" class="text-reset card mb-3 mb-md-35" title="Klasifikasi Baku Komoditi Indonesia - Jasa" data-toggle="tooltip" data-placement="bottom" data-trigger="hover">
					<div class="card-body">
			...
			<div class="w-100"></div>
			<div class="col-auto">
				<a href="kbli-2009" class="text-reset card mb-3 mb-md-35" style="background-color: rgba(255,255,255,.8);" title="Klasifikasi Baku Lapangan Usaha Indonesia 2009" data-toggle="tooltip" data-placement="bottom" data-trigger="hover">
					<div class="card-body">
			...
			<div class="col-auto">
				<a href="kbli-2005" class="text-reset card mb-3 mb-md-35" style="background-color: rgba(255,255,255,.8);" title="Klasifikasi Baku Lapangan Usaha Indonesia 2005" data-toggle="tooltip" data-placement="bottom" data-trigger="hover">
					<div class="card-body">
						<i class="fas fa-fw fa-briefcase fz-64 text-muted"></i>
			...
			<div class="col-auto">
				<a href="kbji-2002" class="text-reset card mb-3 mb-md-35" style="background-color: rgba(255,255,255,.8);" title="Klasifikasi Baku Jabatan Indonesia 2002" data-toggle="tooltip" data-placement="bottom" data-trigger="hover">
					<div class="card-body">
